...
class Owners extends Component {
    ...
    componentWillMount() {
        ...
        axios.get(`http://localhost:8000/api/admin/owners`, {
    ...
    handleVerified = (e) => {
        ...
        toast.configure();
        axios.get(`http://localhost:8000/api/admin/verified/owner/${this.state.user_id}`, {
            headers: {
    ...
    handleBanned = (e) => {
        ...
        toast.configure();
        axios.delete(`http://localhost:8000/api/admin/owner/${this.state.user_id}/banned`, {
            headers: {
                'Accept': 'application/json',
                'Authorization': `Bearer ${sessionStorage.getItem('token')}`
            },
    ...
    handleUnbanned = (e) => {
        ...
        toast.configure();
        axios.get(`http://localhost:8000/api/admin/unbanned/owner/${this.state.user_id}`, {
            headers: {
                'Accept': 'application/json',
                'Authorization': `Bearer ${sessionStorage.getItem('token')}`
            },
