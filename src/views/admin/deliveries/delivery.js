...
class Sales extends Component {
    ...
    openModal = () => {
      ...
      handleRemit = (e) => {
        ...
        toast.configure();
        axios.get(`http://localhost:8000/api/admin/delivery/${this.props.match.params.id}/remit`, {
            headers: {
    ...
    componentWillMount() {
        ...
        axios.get(`http://localhost:8000/api/admin/delivery/${this.props.match.params.id}/sales`, {
